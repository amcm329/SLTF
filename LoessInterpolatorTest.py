...
class LoessInterpolatorTest(object):
    ...
    def constantDataGivesConstantValuesAtNodes(self):
    ...
    def constantDataExtrapolatesConstantValues(self):
    ...
    def constantDataGivesConstantInterpolatedResults(self):
    ...
    def linearDataReturnsDataOnLine(self):
    ...
    def linearDataReturnsDataOnLine2(self):
    ...
    def linearDataExtrapolatesLinearValues(self):
    ...
    def smoothingWithLargeWidthGivesLinearRegressionFit(self):
    ...
    def quadraticDataReturnsDataOnParabolaWithQuadraticInterpolation(self):
    ...
    def quadraticSmoothingWithLargeWidthGivesQuadraticFit(self):
